...
const Navbar = () => {
  ...
  const handleSignOut = ()=>{
    ...
    return (
      ...
      {
        user ? <button onClick={handleSignOut} className='btn w-[150px] bg-black text-white text-lg'>Sign Out</button>
        :<Link to="/login"><button className='btn w-[150px] bg-black text-white text-lg'>Login</button></Link>
      }
